...
class AboutPageState extends State<AboutPage> {
  ...
  Widget build(BuildContext context) {
    ...
    // 添加开源许可信息
    List<Widget> openSourceLicense = [
      Padding(
        padding:
            const EdgeInsetsDirectional.symmetric(horizontal: 15, vertical: 7),
        child: Center(
          child: TextFont(
            text: "open-source-license".tr(),
            fontSize: 20,
            fontWeight: FontWeight.bold,
            textAlign: TextAlign.center,
            maxLines: 5,
      ...
      Padding(
        ...
        child: Tappable(
          ...
          onLongPress: () {
            copyToClipboard("https://www.gnu.org/licenses/gpl-3.0.html");
          },
          color: containerColor,
          borderRadius: getPlatform() == PlatformOS.isIOS ? 10 : 15,
          child: Padding(
    ...
    // 添加fork版本修改说明和贡献者信息
    List<Widget> forkInformation = [
      Padding(
        padding:
            const EdgeInsetsDirectional.symmetric(horizontal: 15, vertical: 7),
        child: Center(
          child: TextFont(
            text: "fork-version-information".tr(),
            fontSize: 20,
            fontWeight: FontWeight.bold,
            textAlign: TextAlign.center,
            maxLines: 5,
