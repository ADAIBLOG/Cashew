...
import '../widgets/settingsContainers.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              SettingsContainerTappable(
                ...
                onTap: () {
                  launchUrl(Uri.parse("https://github.com/jameskokoska/Cashew"));
                },
              ),
              SettingsContainerTappable(
                title: "此修改版",
                ...
                icon: Icons.link_outlined,
                onTap: () {
                  launchUrl(Uri.parse("https://github.com/ADAIBLOG/Cashew"));
                },
              ),
              SizedBox(height: 30),
              Padding(
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                color: HexColor("#8E8E93").withOpacity(0.1),
                borderRadius: BorderRadius.circular(8),
              ),
              child: Icon(icon, size: 20, color: HexColor("#8E8E93")),
            ),
            SizedBox(width: 15),
            Expanded(
              child: Column(
            ...
            Icon(Icons.chevron_right, color: HexColor("#8E8E93")),
          ],
        ),
      ),
    );
