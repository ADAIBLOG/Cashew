...
Future<bool> signInGoogle(
  ...
  if (disableAllCloudServices) {
    print("Google sign-in skipped due to cloud services being disabled");
    if (context != null && waitForCompletion == true) popRoute(context);
    return false;
  }
...
Future<bool> signOutGoogle() async {
  if (disableAllCloudServices) return false;
...
class _BackupManagementState extends State<BackupManagement> {
  ...
  Widget build(BuildContext context) {
    ...
    return PopupFramework(
      ...
      child: Column(
        children: [
          widget.isClientSync && kIsWeb == false ? SizedBox.shrink() : SizedBox.shrink(),
